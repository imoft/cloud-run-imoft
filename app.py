...
async def homepage(request):
    ...
    for i in range(0,3):
        ...
        engine="davinci",
        prompt="This is a speculative question generator.\nQuestion: \"What if the imagination of taxes could be a prosperous choice ?\"\nWord: taxes\n###\nQuestion: \"What if the imagination of Baghdad could be a cyberpunk utopia?\"\nWord: Baghdad\n###\nQuestion: \"What if the imagination of Apple transformed the way we drive?\"\nWord: Apple\n###\nQuestion: \"What if the imagination of UFOs could be a new form of meditation?\"\nWord: UFO\n###\nQuestion: \"What if the imagination of Google could be a key player in world peace?\"\nWord: Google\n###\n\nWords:\n1. Taxes\n2. Baghdad\n3. Apple\n4. UFO\n5. Google\n\nSpeculative Questions\n1. \"What if the imagination of Taxes could be a prosperous choice?\"\n2. \"What if the imagination of Baghdad could be a cyberpunk utopia?\"\n3. \"What if the imagination of Apple transformed the way we drive?\"\n4. \"What if the imagination of UFOs could be a new form of meditation?\"\n5. \"What if the imagination of Google could be a key player in world peace?\"\n\n###\n\n" + prompt,
        temperature=0.5,
        max_tokens=300,
        top_p=1,
        frequency_penalty=1,
